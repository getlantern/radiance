...
type SignupResponse struct {
	...
	ProToken      string                 `protobuf:"bytes,2,opt,name=pro_token,json=proToken,proto3" json:"pro_token,omitempty"`
	LegacyID      int64                  `protobuf:"varint,3,opt,name=legacyID,proto3" json:"legacyID,omitempty"`
...
func (x *SignupResponse) GetProToken() string {
	if x != nil {
		return x.ProToken
	}
	return ""
...
func (x *SignupResponse) GetLegacyID() int64 {
	if x != nil {
		return x.LegacyID
	}
	return 0
...
func (*Purchase) Descriptor() ([]byte, []int) {
	return file_api_protos_auth_proto_rawDescGZIP(), []int{19}
}
...
func (*LoginResponse_Device) Descriptor() ([]byte, []int) {
	return file_api_protos_auth_proto_rawDescGZIP(), []int{9, 0}
}
...
func (*LoginResponse_UserData) Descriptor() ([]byte, []int) {
	return file_api_protos_auth_proto_rawDescGZIP(), []int{9, 1}
}
...
func (x *LoginResponse_UserData_SubscriptionData) Reset() {
	*x = LoginResponse_UserData_SubscriptionData{}
	mi := &file_api_protos_auth_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginResponse_UserData_SubscriptionData) Descriptor() ([]byte, []int) {
	return file_api_protos_auth_proto_rawDescGZIP(), []int{9, 1, 0}
}
...
const file_api_protos_auth_proto_rawDesc = "" +
	...
	"\x04temp\x18\x05 \x01(\bR\x04temp\"o\n" +
	"\x0eSignupResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\tpro_token\x18\x02 \x01(\tR\bproToken\x12\x1a\n" +
	"\blegacyID\x18\x03 \x01(\x03R\blegacyID\x12\x14\n" +
...
var file_api_protos_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_api_protos_auth_proto_goTypes = []any{
	...
	(*SignupEmailResendRequest)(nil),                // 3: SignupEmailResendRequest
	(*ConfirmSignupRequest)(nil),                    // 4: ConfirmSignupRequest
	(*GetSaltResponse)(nil),                         // 5: GetSaltResponse
	(*PrepareRequest)(nil),                          // 6: PrepareRequest
	(*PrepareResponse)(nil),                         // 7: PrepareResponse
	(*LoginRequest)(nil),                            // 8: LoginRequest
	(*LoginResponse)(nil),                           // 9: LoginResponse
	(*StartRecoveryByEmailRequest)(nil),             // 10: StartRecoveryByEmailRequest
	(*CompleteRecoveryByEmailRequest)(nil),          // 11: CompleteRecoveryByEmailRequest
	(*ChangeEmailRequest)(nil),                      // 12: ChangeEmailRequest
	(*CompleteChangeEmailRequest)(nil),              // 13: CompleteChangeEmailRequest
	(*DeleteUserRequest)(nil),                       // 14: DeleteUserRequest
	(*ValidateRecoveryCodeRequest)(nil),             // 15: ValidateRecoveryCodeRequest
	(*ValidateRecoveryCodeResponse)(nil),            // 16: ValidateRecoveryCodeResponse
	(*LogoutRequest)(nil),                           // 17: LogoutRequest
	(*BaseResponse)(nil),                            // 18: BaseResponse
	(*Purchase)(nil),                                // 19: Purchase
