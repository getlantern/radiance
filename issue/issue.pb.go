...
const (
	...
	ReportIssueRequest_SPLIT_TUNNEL       ReportIssueRequest_ISSUE_TYPE = 11
	ReportIssueRequest_SMART_ROUTING      ReportIssueRequest_ISSUE_TYPE = 12
	ReportIssueRequest_SERVER_SELECTION   ReportIssueRequest_ISSUE_TYPE = 13
	ReportIssueRequest_UPGRADE_FAIL       ReportIssueRequest_ISSUE_TYPE = 14
)
...
const file_issue_issue_proto_rawDesc = "" +
	...
	"\x13ReportIssueResponse\"\xc4\x06\n" +
	...
	"\acontent\x18\x03 \x01(\fR\acontent\"\xec\x01\n" +
	"\n" +
	"ISSUE_TYPE\x12\x10\n" +
	...
	"\vUPDATE_FAIL\x10\n" +
	"\x12\x10\n" +
	"\fSPLIT_TUNNEL\x10\v\x12\x11\n" +
	"\rSMART_ROUTING\x10\f\x12\x14\n" +
	"\x10SERVER_SELECTION\x10\r\x12\x10\n" +
	"\fUPGRADE_FAIL\x10\x0eB&Z$github.com/getlantern/radiance/issueb\x06proto3"
