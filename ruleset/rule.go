...
func newMutableRuleSet(dataPath, tag string, enable bool) *MutableRuleSet {
...
// RouteRule returns a base routing [option.Rule] config with the ruleset and an outboundTag set.
// Additional conditions can be added as needed.
func RouteRule(ruleset, outboundTag string) option.Rule {
	return option.Rule{
		Type: constant.RuleTypeDefault,
		DefaultOptions: option.DefaultRule{
			RawDefaultRule: option.RawDefaultRule{
				RuleSet: badoption.Listable[string]{ruleset},
			},
