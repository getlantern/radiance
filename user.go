...
func (u *User) CompleteRecoveryByEmail(ctx context.Context, email, code, salt, verifier string) error {
	// TODO: implement me!
	return ErrNotImplemented
}
...
func (u *User) CompleteChangeEmail(ctx context.Context, newEmail, code, verifier string) error {
	// TODO: implement me!
	return ErrNotImplemented
}
